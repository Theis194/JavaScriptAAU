...
function validateBMIRecordForm(bmiData){
  ...
  if(bmiData.has("userName") && bmiData.has("weight") && bmiData.has("height") && bmiData.has("age") && bmiData.has("sex")){
    ...
    if((minHeight <= height) && (height <= maxHeight) &&
       ...
       ((sex === "male") || (sex === "female") || (sex === "indifferent"))){
...
<output>
Your BMI is ${bmiStatus.bmi}. Since last, it has changed ${bmiStatus.delta}. ${bmiCheck(bmiStatus)} 
</output>
<nav>
  <a href="/">Home</a>
  <a href="/bmi-records?userName=${bmiStatus.userName}">Records</a>
